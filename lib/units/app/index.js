...
module.exports = function (options) {
  ...
  app.post('/app/api/v1/allowDevices/update', express.json(), function (req, res) {
  ...
  app.get('/app/api/v1/pyLDAP', function (req, res) {
    ...
    var reqURl = `http://${PY_LDAP_HOST}:3002${req.query.param}/${req.user.name}`;
